        ...
        <div className="min-h-screen bg-background pt-28 pb-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-12 border-b-4 border-foreground pb-8">
                    <h1 className="text-5xl sm:text-8xl font-black tracking-tighter mb-4 uppercase">Storybooks</h1>
                    <p className="text-xl sm:text-2xl font-medium max-w-2xl">
                        Illustrated, bilingual, read-aloud — every word plays a speaker recording and links to its
                        dictionary entry.
                    </p>
                </div>

                {BOOKS.length === 0 ? (
                    <p className="text-lg text-muted-foreground">No storybooks yet — check back soon.</p>
                ) : (
